<template>
  <div class="dialog">
    <mu-appbar :title="userData.self.name"
               :zDepth="0">
      <mu-button small flat color="blue" slot="left" @click="showDialog_x">
        <mu-icon value="arrow_back"></mu-icon>
      </mu-button>
      <div class="right-top" slot="right">
        <mu-button small flat color="blue">
          <mu-icon value="videocam"></mu-icon>
         </mu-button>
        <mu-button small flat color="blue">
          <mu-icon value="call"></mu-icon>
        </mu-button>
        <mu-button small flat color="blue" @click="showPersonindex_x">
    ...
    <div>
      ...
      <my-dialogue :userData="userData" class="dialogue" @scrollC="scrollC" />
      <br><br><br><br>
    ...
    <div class="footer" ref="footer">
      <div class="top">
        ...
        <mu-button @click="sendValue" icon>
